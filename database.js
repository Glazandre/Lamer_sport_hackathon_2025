...
getDemoData() {
    return {
        participants: [], // Убрал демо-участников
        results: [], // Убрал демо-результаты
        disciplines: [
            {
                id: 1,
                name: 'Бег 100 м',
        ...
        lastId: {
            participants: 0, // Сбросил ID участников
            results: 0, // Сбросил ID результатов
            disciplines: 5,
            teams: 2,
    ...
    addParticipant(participantData) {
        ...
        const participantNumber = 100 + this.data.participants.length + 1;
